...
import com.pindiboy.weddingvideos.model.bean.Item;
...
public class VideoListAdapter extends BaseQuickAdapter<Item, BaseViewHolder> {
    public VideoListAdapter(List<Item> data) {
